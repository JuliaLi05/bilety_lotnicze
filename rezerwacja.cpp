...
void rezerwacjaBiletu(int id_lotu, const char*imie, const char* nazwisko){
    ...
    }
    {
        ...
        std::strncpy(rezerwacja.imie, imie, MAXLINE);
        rezerwacja.imie[MAXLINE - 1] = '\0';
        std::strncpy(rezerwacja.nazwisko, nazwisko, MAXLINE);
        rezerwacja.nazwisko[MAXLINE - 1] = '\0';
...
void dodajLot(int id_lotu, const char* odlot, const char*przylot, int miejsca, double cena){
    ...
    std::strncpy(nowy.miasto_odlotu, odlot, MAXLINE - 1);
    nowy.miasto_odlotu[MAXLINE - 1] = '\0';
    std::strncpy(nowy.miasto_przylotu, przylot, MAXLINE - 1);
    nowy.miasto_przylotu[MAXLINE - 1] = '\0';
